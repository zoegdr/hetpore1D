function plot_strain_n_flux_vs_Z(T,dUdZ,Q,Zs,params, ymin1, ymax1, ymin2, ymax2)

% Multiple profiles decreased stiffness VS Z
% T, dUdZ, Q and params must be cells of size 2x4
% Each cell of T, dUdZ, Q contains the solution for a particular set of
% parameter, and each cell of params contains the corresponding parameter
% set
% ymin1, ymax1 are y limits for strain
% ymin2, ymax2 are y limits for flux

%% Set up

% These are used to plot the insets of applied stress and applied
% displacement; since they are plotted without units, they are
% representative of any amplitude / frequency
