...
set(fig,'Position',[0 0 18 12.5])
set(fig,'PaperPositionMode','Auto','PaperUnits','centimeters','PaperSize',[18 12.5])

% Colour scheme
cmap = slanCM('Blues',8);
cmap_trunc = cmap(3:8,:);

ax11 = axes('Units','centimeters','InnerPosition',[1.5 9.25 7.5 2.5]);
    hold(ax11,"on")
    box(ax11,"on")
    ...
    title('$\omega=1$, 20 cycles','Interpreter','latex','Rotation',0,'FontSize',12)

ax12 = axes('Units','centimeters','InnerPosition',[10 9.25 7.5 2.5]);
    hold(ax12,"on")
    box(ax12,"on")
    ...
    title('$\omega=10$, 20 cycles','Interpreter','latex','Rotation',0,'FontSize',12)

ax21 = axes('Units','centimeters','InnerPosition',[1.5 5.25 7.5 2.5]);
    hold(ax21,"on")
    box(ax21,"on")
    ...
    title('$\omega=30$, 20 cycles','Interpreter','latex','Rotation',0,'FontSize',12)
...
ax22 = axes('Units','centimeters','InnerPosition',[10 5.25 7.5 2.5]);
    ...
    title('$\omega=50$, 20 cycles','Interpreter','latex','Rotation',0,'FontSize',12)
...
ax3 = axes('Units','centimeters','InnerPosition',[1.5 1.25 16 2.5]);
    ...
    % Labels
    xlabel('$t$','Interpreter','latex','Rotation',0,'FontSize',12);
    yticks([0 0.1 0.2])

    title('$\omega=100$, 100 cycles','Interpreter','latex','Rotation',0,'FontSize',12)
